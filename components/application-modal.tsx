...
  isOpen: boolean
  onClose: () => void
  programTitle: string // Program title is passed as a prop
}
...
        .from("contacts") // Assuming all leads go to the 'contacts' table
        .insert([
          {
            name: formData.name,
            email: formData.email,
            phone: formData.phone,
            // Send the program title and experience level as data
            program_title: programTitle, // Matches your new Supabase column
            experience: formData.experience, // Matches your new Supabase column
            message: formData.message,
          },
        ])

      if (supabaseError) {
        throw new Error("Database Error: Could not save application.")
      }
